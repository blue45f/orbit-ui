...
export type AsProps<T extends React.ElementType> = { as: T } & Omit<
  React.ComponentPropsWithoutRef<T>,
  'as'
>

export type OptionalAsProps<T extends React.ElementType> = { as?: T } & Omit<
  React.ComponentPropsWithoutRef<T>,
  'as'
>
...
export type StyleProtectedOptionalAsProps<T extends React.ElementType> = Omit<
...
> = DistributiveOmit<
  ComponentPropsWithRef<React.ComponentType extends Component ? DefaultComponent : Component>,
  'as'
>
...
export type ExtractKeysEndingWith<T, Suffix extends string> = T extends `${string}${Suffix}`
  ? T
  : never
