  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          'h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors'
        ),
        ...
        day_outside:
          'day-outside text-slate-500 aria-selected:bg-slate-100/50 aria-selected:text-slate-500 aria-selected:opacity-30 dark:text-slate-400 dark:aria-selected:bg-slate-800/50',
