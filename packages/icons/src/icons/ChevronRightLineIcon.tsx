...
function ChevronRightLineIcon(props: IconProps) {
  return (
  <IconRoot {...props}>
    <path
      fillRule='evenodd'
...
ChevronRightLineIcon.displayName = 'ChevronRightLineIcon'

export default memo(ChevronRightLineIcon)
export { ChevronRightLineIcon }
