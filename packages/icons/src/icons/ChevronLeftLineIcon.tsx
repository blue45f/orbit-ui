...
function ChevronLeftLineIcon(props: IconProps) {
  return (
  <IconRoot {...props}>
    <path
      fillRule='evenodd'
...
ChevronLeftLineIcon.displayName = 'ChevronLeftLineIcon'

export default memo(ChevronLeftLineIcon)
export { ChevronLeftLineIcon }
