...
// CSS variable name for dynamic alignItems (used as inline style)
export const alignItemsVar = '--boxed-checkbox-align-items'
...
export const checkboxWrapper = 'shrink-0'
