...
const RangeSelectionRender = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', width: '320px' }}>
      ...
      >
        선택된 범위: <strong style={{ color: '#1e293b' }}>{range[0]}</strong> ~{' '}
        <strong style={{ color: '#1e293b' }}>{range[1]}</strong>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        {labels.map((l, i) => (
          <span
            ...
            style={{
              fontSize: '11px',
              color: i === quality[0] ? colors[i] : '#94a3b8',
              fontWeight: i === quality[0] ? 700 : 400,
            }}
          >
            {l}
          </span>
        ...
        <div style={{ padding: '14px 16px', borderBottom: '1px solid #f8fafc' }}>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: '11px', color: '#94a3b8', marginTop: '2px' }}>
                Preview:{' '}
                <span style={{ fontSize: `${fontSize[0]}px`, fontWeight: 600, color: '#6366f1' }}>
                  Aa
                </span>
              </div>
            </div>
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
        ...
        <div>
          <div
            style={{ fontSize: 20, fontWeight: 800, color: '#1e293b', letterSpacing: '-0.02em' }}
          >
            {hexColor}
          </div>
    ...
    >
      ...
      <div
        style={{
          ...
          border: `1.5px solid ${priority.color}30`,
        }}
      >
        <div>
          <div
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: priority.color }}>
            {priority.label}
          </div>
        </div>
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: 36, fontWeight: 900, color: priority.color, lineHeight: 1 }}>
            {score}
          </div>
      ...
      {[
        ...
        <div key={item.label}>
          ...
          <Slider value={item.value} max={100} step={5} onValueChange={item.onChange} />
          <div
            style={{
              display: 'flex',
              justifyContent: 'space-between',
  ...
  return (
    ...
    >
          ...
          >
            <div>
              <div
                style={{
                  fontSize: 12,
                  fontWeight: 600,
                  color: selectedTask === i ? '#4f46e5' : '#1e293b',
                }}
              >
                {task.title}
              </div>
            ...
            <div
              style={{
                fontSize: 18,
                fontWeight: 800,
                color: selectedTask === i ? '#6366f1' : '#94a3b8',
              }}
            >
              {task.current}pt
            </div>
      ...
      <div>
        ...
        <Slider value={pointIdx} max={FIB_POINTS.length - 1} step={1} onValueChange={setPointIdx} />
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 6 }}>
          {FIB_POINTS.map((pt, i) => (
            <span
              key={pt}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <span style={{ fontSize: 13, color: 'var(--sem-eclipse-color-foregroundTertiary)' }}>
          🔈
        </span>
        <div style={{ flex: 1 }}>
          <Slider
          ...
          return (
            <div
              ...
              style={{
                ...
                padding: '8px 12px',
                borderRadius: 6,
                border: `1px solid ${inRange ? 'var(--sem-eclipse-color-fillPrimary)' : 'var(--sem-eclipse-color-borderSubtle)'}`,
                background: inRange
        ...
        return (
          <div key={m.label} style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <Slider value={m.value} onValueChange={m.onChange} min={0} max={100} step={5} />
  ...
  const controls = [
    ...
    },
    {
      ...
      formatValue: (v: number) =>
        v < 50 ? `차가움 ${50 - v}` : v > 50 ? `따뜻함 ${v - 50}` : '중립',
    },
  ]
        ...
        <div key={ctrl.id} style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span style={{ fontSize: 12, color: '#8e8e93' }}>
              {ctrl.formatValue(ctrl.value[0])}
            </span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <span style={{ fontSize: 16 }}>{ctrl.iconMin}</span>
            <div style={{ flex: 1 }}>
              <Slider value={ctrl.value} onValueChange={ctrl.onChange} min={0} max={100} step={1} />
            </div>
  ...
  return (
    ...
    >
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 2 }}>
          IssueTracker Design — RICE 스코어링 패턴
        </div>
      </div>
      ...
      <div
        style={{
          padding: '12px 16px',
          borderRadius: 8,
          background: `${priorityColor[priority]}10`,
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: priorityColor[priority] }}>
            {score}
          </div>
        </div>
        <div style={{ textAlign: 'right' }}>
...
export const IssueTracker_이슈_우선순위_계산기: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'IssueTracker RICE 스코어링 패턴. 긴급도/영향도/작업량 3개 Slider로 우선순위 자동 계산. 점수에 따라 urgent/high/medium/low 동적 판정.',
      },
    },
  },
  ...
  return (
    ...
    >
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 2 }}>
          DeployPlatform Design — 사용량 슬라이더
        </div>
      </div>
      ...
      {[
        ...
        <div key={r.label} style={{ marginBottom: 16 }}>
          ...
          <Slider value={r.value} onValueChange={(v) => r.set(v)} min={0} max={r.max} step={10} />
        </div>
      ))}
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 700, color: isOver ? '#ef4444' : '#0f172a' }}>
            {total} / {limit}GB
          </span>
        </div>
...
export const DeployPlatform_리소스_할당_슬라이더: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'DeployPlatform 리소스 할당 패턴. 대역폭/캐시/함수 실행량 3개 Slider 합산, 한도 초과 시 경고 표시 및 게이지 빨간색 전환.',
      },
    },
  },
...
function IssueTrackerDeployPlatformABTest144Render() {
  ...
  const statusLabel =
    confidence[0] >= 95 ? '통계적으로 유의함' : confidence[0] >= 80 ? '보통' : '신뢰도 부족'
  ...
  return (
    ...
    >
      <div style={{ marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 2 }}>
          IssueTracker + DeployPlatform — 실험 파라미터
        </div>
      </div>
...
export const IssueTracker_DeployPlatform_AB_테스트_설정: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'IssueTracker + DeployPlatform A/B 실험 파라미터 슬라이더. 트래픽 분배 / 신뢰도 임계값 / 기간 3개 Slider. 분배 시각화 바, 신뢰도 상태 색상 동적 변환.',
      },
    },
  },
...
function ComposableUIAudioPlayerRender() {
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          borderTop: '1px solid var(--sem-eclipse-color-borderPrimary, #e2e8f0)',
          paddingTop: 14,
          display: 'flex',
          flexDirection: 'column',
          gap: 10,
      ...
      >
        {[
          { label: '볼륨', value: volume, set: setVolume, icon: '🔊' },
          { label: '저음', value: bass, set: setBass, icon: '🎵' },
          { label: '고음', value: treble, set: setTreble, icon: '✦' },
        ].map((ctrl) => (
          <div key={ctrl.label} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontSize: 11, color: '#94a3b8', width: 24, textAlign: 'right' }}>
              {ctrl.value[0]}
            </span>
          </div>
        ))}
...
export const ComposableUI_오디오_플레이어_슬라이더: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'ComposableUI 오디오 컨트롤 패턴. 트랙 재생 진행바 + 볼륨/저음/고음 EQ 슬라이더. 재생/일시정지 버튼, 시간 포맷 표시.',
      },
    },
  },
      ...
      >
        ...
        <span
          style={{
            ...
            padding: '2px 8px',
            borderRadius: 99,
            background: nightShift ? '#ff9f0a30' : '#3a3a3c',
            color: nightShift ? '#ff9f0a' : '#8e8e93',
            cursor: 'pointer',
          }}
          onClick={() => setNightShift(!nightShift)}
        >
          Night Shift {nightShift ? 'ON' : 'OFF'}
        </span>
      </div>
      <div style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 12, color: warmth[0] > 60 ? '#ff9f0a' : '#f2f2f7' }}>
              {warmth[0] < 30
                ? '차가운 (6500K)'
                : warmth[0] < 60
                  ? '중간 (5500K)'
        ...
        >
          예상 배터리 영향:{' '}
          <span style={{ color: brightness[0] > 75 ? '#ff453a' : '#30d158', fontWeight: 600 }}>
            {brightness[0] > 75 ? '높음' : '낮음'}
          </span>
        </div>
      </div>
    </div>
...
export const CommandPalette_디스플레이_밝기_슬라이더: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'CommandPalette 시스템 환경설정 패턴. 다크 UI에서 밝기/대비/색온도 3개 슬라이더. Night Shift 토글, 배터리 영향 동적 표시, 밝기 레벨 라벨.',
      },
    },
  },
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 12, color: '#64748b', marginBottom: 20 }}>
        슬라이더로 사용량을 설정하면 가격이 실시간으로 계산됩니다.
      </div>
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
            ...
            <span
              style={{
                fontSize: 13,
                color: retentionDays > 90 ? '#f59e0b' : '#6366f1',
                fontWeight: 700,
              }}
            >
              {retentionDays}일
          ...
          <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 4 }}>
            {retentionDays > 90 ? '+$5/월 (90일 초과)' : '무료 포함'}
          </div>
        </div>
      </div>
      ...
      >
        <div>
          ...
          >
            ${total}
            <span style={{ fontSize: 13, fontWeight: 400, color: '#94a3b8' }}>/mo</span>
          </div>
        </div>
        <button
          style={{
...
export const ComposableUI_CommandPalette_요금제_계산기: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'ComposableUI + CommandPalette 요금제 커스터마이즈 패턴. 스토리지/팀 멤버/데이터 보존 3개 슬라이더로 실시간 요금 계산. 90일 초과 시 추가 요금 동적 반영.',
      },
    },
  },
