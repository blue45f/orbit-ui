...
export type TabProps = Omit<TabItemProps, keyof TabItemSpecificProps> & ComponentThemeProps<typeof vars.com.tab>
...
const TabRoot = forwardRef<HTMLButtonElement, TabProps>((props, ref) => {
  ...
  } = filterComponents(Children.toArray(children) as Awaited<ReactNode>[], Leading, Center, Trailing)
