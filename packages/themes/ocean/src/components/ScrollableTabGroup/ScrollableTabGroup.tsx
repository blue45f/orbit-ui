...
export type ScrollableTabGroupProps = Omit<BaseScrollableTabGroupProps, keyof BaseScrollableTabGroupSpecificProps> &
...
const ScrollableTabGroupTab = forwardRef<HTMLButtonElement, BaseScrollableTabGroupTabProps>((props) => {
  ...
  return (
    <>
      {leading.length > 0 && <BaseScrollableTabGroup.TabLeading>{leading}</BaseScrollableTabGroup.TabLeading>}
      {center.length > 0 && <BaseScrollableTabGroup.TabCenter>{center}</BaseScrollableTabGroup.TabCenter>}
      {trailing.length > 0 && <BaseScrollableTabGroup.TabTrailing>{trailing}</BaseScrollableTabGroup.TabTrailing>}
    </>
  )
})
 ...
 * ```
 */
export const ScrollableTabGroup: ScrollableTabGroupComponent = Object.assign(ScrollableTabGroupRoot, {
