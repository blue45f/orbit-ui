...
export const 사용_예시 = {
  render: () => (
    <Flex flexDirection='column' rowGap='30px' style={{ width: '400px', padding: '20px' }}>
      <div>
        <h3 style={{ margin: '0 0 10px 0', fontSize: '16px', fontWeight: 'bold' }}>리스트 아이템 구분</h3>
        <Flex flexDirection='column' rowGap='10px'>
          <div style={{ padding: '10px', backgroundColor: '#f5f5f5', borderRadius: '4px' }}>아이템 1</div>
          <Divider />
          <div style={{ padding: '10px', backgroundColor: '#f5f5f5', borderRadius: '4px' }}>아이템 2</div>
          <Divider />
          <div style={{ padding: '10px', backgroundColor: '#f5f5f5', borderRadius: '4px' }}>아이템 3</div>
        </Flex>
      </div>
      <div>
        <h3 style={{ margin: '0 0 10px 0', fontSize: '16px', fontWeight: 'bold' }}>버튼 그룹 구분</h3>
