...
```
┌─────────────────────────────────────────────────┐
│  Theme Layer (@heejun-com/theme-eclipse)          │  ← 사용자가 import
│  디자인 토큰이 적용된 완성된 컴포넌트              │
│  SolidButton, TextField, Modal, DataTable ...   │
├─────────────────────────────────────────────────┤
│  Core Layer (@heejun-com/core)                    │  ← Headless
...
| Package | Description |
|---------|-------------|
| [`@heejun-com/core`](./packages/core) | Headless 기본 컴포넌트 + Primitives (Layer, Slot, Animation) |
| [`@heejun-com/theme-eclipse`](./packages/theme-eclipse) | Eclipse 테마 컴포넌트 (50+ components) |
| [`@heejun-com/icons`](./packages/icons) | SVG 아이콘 라이브러리 |
...
```bash
pnpm add @heejun-com/theme-eclipse @heejun-com/icons
```

```bash
npm install @heejun-com/theme-eclipse @heejun-com/icons
```

> **Live Storybook**: https://orbit-ui-pink.vercel.app/
>
> **npm**: https://www.npmjs.com/org/heejun-com

### Setup

```tsx
import { EclipseProvider, SolidButton } from '@heejun-com/theme-eclipse'
